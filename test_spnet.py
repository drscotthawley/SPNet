...
def test_network(weights_file="", datapath="", fraction=1.0, log_dir="", batch_size=32):
    np.random.seed(1)
    ...
    show_pred_ellipses(Yt, Yp, test_file_list, log_dir=log_dir)
...
if __name__ == '__main__':
    ...
    model = test_network(weights_file=args.weights, datapath=args.datapath, fraction=args.fraction, log_dir=args.logdir, batch_size=args.batch_size)
